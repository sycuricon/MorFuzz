...
extern "C" int coverage_collector(unsigned long int cov) {
  ...
  sprintf(compile_cmd,
          ...
          "--steps gcc_compile",
          dv_test_list[test_index], seed);
  sprintf(testcase, "testcase_fig9/asm_test/%s_0.o", dv_test_list[test_index]);
  sprintf(testcase_bin, "testcase_fig9/asm_test/%s_0.bin",
          dv_test_list[test_index]);
  sprintf(testcase_hex, "testcase_fig9/asm_test/%s_0.hex",
          dv_test_list[test_index]);
